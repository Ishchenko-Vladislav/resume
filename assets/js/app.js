const headerCurrent = document.querySelector(".header-rezume_current");
...
back.addEventListener("click", () => {
  ...
  if (currentPage >= 2) {
    document.querySelector(".wrapper-rezume").classList.remove("last");
  }
});
...
addMoreScholl.addEventListener("click", () => {
  ...
  addMoreScholl.classList.add("disabled");
});
  ...
  if (addedSchool == 0) {
    if (
      ...
      if (!user.educations.includes(objSchool1)) {
        ...
        document.querySelector(".wrapper-rezume").classList.add("last");
        fetchingApi(user);
        console.log(user);
      }
    }
...
document
  ...
  .addEventListener("click", () => {
    ...
    schoolDescInput1.value = "";
    schoolInfoDegreeInput1.value = "";
    addMoreScholl.classList.remove("disabled");
